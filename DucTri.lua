...
if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then 
	...
	function library:Evil()
		...
		Main.AnchorPoint = DucTri2.new(0.5, 0.5)
		...
		Logo.Parent = Main
		Logo.Active = true
		Logo.AnchorPoint = DucTri2.new(0,0)
		...
		Logo_Background.AnchorPoint = DucTri2.new(0,0)
		...
		function tabs:CreateTab(options)
			...
			game:GetService("RunService").RenderStepped:Connect(function()
				if scrollingEnabled then
					...
					ScrollingFrame.CanvasPosition = DucTri2.new(
			...
			function sections:CreateSection(options)
				...
				function functionitem:AddLabelX(options)
					...
					Label.AnchorPoint = DucTri2.new(0.5, 0.5)
					...
					Label22.AnchorPoint = DucTri2.new(0, 0.5)
					...
					Label23.AnchorPoint = DucTri2.new(0, 0.5)
					...
					Text.Name = "Text"
					Text.Parent = Label
					Text.AnchorPoint = DucTri2.new(0.5, 0.5)
				...
				function functionitem:ButtonTog(Title, default, callback)
					...
					TextLabel_4.AnchorPoint = DucTri2.new(0.5, 0.5)
				...
				function functionitem:AddButton(options)
					...
					TextLabel_3.AnchorPoint = DucTri2.new(0.5, 0.5)
				...
				function functionitem:AddToggle(options)
					...
					MainToggle_3.AnchorPoint = DucTri2.new(0.5, 0.5)
				...
				function functionitem:AddTextbox(options)
					...
					TextboxHoler.AnchorPoint = DucTri2.new(0.5, 0.5)
					...
					HeadTitle.AnchorPoint = DucTri2.new(0.5, 0.5)
				...
				function functionitem:AddMultiDropdown(options)
					...
					ImageButton.Parent = MainDropDown_2
					ImageButton.AnchorPoint = DucTri2.new(0, 0.5)
				...
				function functionitem:AddSlider(options)
					...
					CustomValue.AnchorPoint = DucTri2.new(0.5, 0.5)
					...
					ValueFrame.AnchorPoint = DucTri2.new(0.5, 0.5)
					...
					PartValue.AnchorPoint = DucTri2.new(0.5, 0.5)
					...
					ConneValue.AnchorPoint = DucTri2.new(0.7, 0.7)
				...
				function functionitem:AddColorpicker(text, preset, callback)
					...
					ColorSelection.AnchorPoint = DucTri2.new(0.5, 0.5)
					...
					HueSelection.AnchorPoint = DucTri2.new(0.5, 0.5)
	...
	function LoadSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfolder("DucTri Hub") then
				makefolder("DucTri Hub")
			end
			if not isfolder("DucTri Hub/Blox Fruits/") then
				makefolder("DucTri Hub/Blox Fruits/")
			end
			if not isfile("DucTri Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				writefile("DucTri Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
			else
				local Decode = game:GetService("HttpService"):JSONDecode(readfile("DucTri Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
	...
	function SaveSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfile("DucTri Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				...
				writefile("DucTri Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
			end
		else
			return warn("Status : Undetected Executor")
		end
...
function GetMaterial(matname)
	...
	local function QuestCheck()
		...
		--game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",DucTri3.new(61163.8515625, 11.6796875, 1819.7841796875))
	...
	function InfAbility()
		if _G.Infinit_Ability then
			if not game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
				...
				inf.Acceleration = DucTri3.new(0,0,0)
				inf.Archivable = true
				inf.Drag = 20
				...
				inf.SpreadAngle = DucTri2.new(360,360)
	...
	game:GetService("Players").LocalPlayer.Idled:connect(function()
		vu:Button2Down(DucTri2.new(0,0),workspace.CurrentCamera.CFrame)
		wait(1)
		vu:Button2Up(DucTri2.new(0,0),workspace.CurrentCamera.CFrame)
	end)
			...
			game:GetService("RunService").Stepped:Connect(function()
				if _G.Auto_Farm_Level or _G.AutoObservation or _G.TPNPCDF or _G.Auto_Kill_Player or AutoFarmMaterial or _G.AutoBuddySwords or _G.AutoCavander or _G.Bboat or _G.TPTOBOAT or _G.AutoEvent or _G.QRepairBoat or _G.QRepairBoat2 or _G.WoodPlank or _G.AutoMirageIsland or _G.Auto_Gear or _G.TptoKisuneIsland  or _G.NeareastFarm or _G.TptoKisuneshrine or _G.AutoFarmBossHallow or _G.Auto_Yama or _G.Auto_Sea_King or _G.Auto_Dack_Coat or _G.Auto_Rip_Indar or _G.Auto_Farm_Mastery_Gun or _G.Auto_Farm_All_Sword or _G.Auto_Awakening_One_Quest or _G.Auto_Lever_UnLock or _G.Auto_Complete_Trial or _G.Auto_Farm_Mastery_Fruit or Auto_Mirage_Island or Auto_Gear or _G.Auto_Farm_All_Boss or _G.Auto_New_World or _G.Auto_Third_World or _G.Auto_Farm_Chest or _G.Auto_Farm_Boss or _G.Auto_Castle_Raid or _G.Auto_Elite_Hunter or _G.Auto_Cake_Prince or _G.Auto_Farm_All_Boss or _G.Auto_Saber or _G.Auto_Pole or _G.Auto_Farm_Scrap_and_Leather or _G.Auto_Farm_Angel_Wing or _G.Auto_Factory_Farm or _G.Auto_Farm_Ectoplasm or _G.Auto_Bartilo_Quest or _G.Auto_Rengoku or _G.Auto_Farm_Radioactive or _G.Auto_Farm_Vampire_Fang or _G.Auto_Farm_Mystic_Droplet or _G.Auto_Farm_GunPowder or _G.Auto_Farm_Dragon_Scales or _G.Auto_Evo_Race_V2 or _G.Auto_Swan_Glasses or _G.Auto_Dragon_Trident or _G.Auto_Soul_Reaper or _G.Auto_Farm_Fish_Tail or _G.Auto_Farm_Mini_Tusk or _G.Auto_Farm_Magma_Ore or _G.Auto_Farm_Bone or _G.Auto_Farm_Conjured_Cocoa or _G.Auto_Open_Dough_Dungeon or _G.Auto_Rainbow_Haki or _G.Auto_Musketeer_Hat or _G.Auto_Holy_Torch or _G.Auto_Canvander or _G.Auto_Twin_Hook or _G.Auto_Serpent_Bow or _G.Auto_Fully_Death_Step or _G.Auto_Fully_SharkMan_Karate or _G.Teleport_to_Player or _G.Auto_Kill_Player_Melee or _G.Auto_Kill_Player_Gun or _G.Start_Tween_Island or _G.Auto_Next_Island or _G.Auto_Kill_Law then
					if not game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("BodyClip") then
						...
						Noclip.MaxForce = DucTri3.new(100000,100000,100000)
						Noclip.Velocity = DucTri3.new(0,0,0)
					end
				else	
	...
	local function Bypass(Position)
		...
		if W3 then
			if (CFramePos.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 4000 then
				game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",DucTri3.new(-5076.60107, 314.54129, -3152.13086, 0.351963997, -4.56893581e-08, -0.93601352, 6.84364423e-08, 1, -2.30789325e-08, 0.93601352, -5.59344855e-08, 0.351963997))
			end
		end
								...
								if (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 2000 and v.Humanoid.Health > 0 then
									repeat
									   wait() 
										...
										v.HumanoidRootPart.Size = DucTri3.new(80, 80, 80)
										StartMagnet = true
										FastAttack = true
										toTarget(v.HumanoidRootPart.CFrame * MethodFarm)
										if not FastAttack then
										game:GetService 'VirtualUser':CaptureController()
										game:GetService 'VirtualUser':Button1Down(DucTri2.new(1280, 672))
										end 
										...
										if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
											repeat task.wait()
												...
												if not string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, QuestCheck()[6]) then
													...
													PosMon = v.HumanoidRootPart.CFrame
													v.HumanoidRootPart.Size = DucTri3.new(60,60,60)
													v.HumanoidRootPart.CanCollide = false
				...
				for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
					if v.Name == "God's Guard" then
						...
						if _G.Auto_Farm_Level and (CFrameMon.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 500 then
							game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",DucTri3.new(-4607.82275, 872.54248, -1667.55688))
						end
					...
					if string.find(quest,"Defeat") then
						if game.Players[getgenv().SelectPly].Data.Level.Value >= 20 and game.Players[getgenv().SelectPly].Data.Level.Value <= MyLevel * 2 then
							repeat task.wait()
								...
								game:GetService("Players")[getgenv().SelectPly].Character.HumanoidRootPart.Size = DucTri3.new(120,120,120)
								...
								for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
									if v.Name == "Ice Admiral" and v.Humanoid.Health > 0 then
										repeat wait()
											...
											getgenv().ToTarget(v.HumanoidRootPart.CFrame * MethodFarm)
											game:GetService("VirtualUser"):CaptureController()
											game:GetService("VirtualUser"):Button1Down(DucTri2.new(1280, 870),workspace.CurrentCamera.CFrame)
									...
									if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
										...
										repeat task.wait()
											...
											if v.Humanoid.Health <= v.Humanoid.MaxHealth * _G.Settings.HealthMs/100 then 
												_G.UseSkill = true
												getgenv().ToTarget(v.HumanoidRootPart.CFrame * CFrame.new(0,_G.Settings.Distance,_G.Settings.DistanceY))
												v.HumanoidRootPart.Size = DucTri3.new(120,120,120)
												v.HumanoidRootPart.CanCollide = false
												v.Head.CanCollide = false
												BringMobFarm = true
												v.HumanoidRootPart.Transparency = 1
	...
	function CheckMonFF(trg_part)
		...
		for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
			if v.Name == QuestCheck()[3] then
				...
				local AccPos = DucTri2.new(ePos.x, ePos.y)
				local mousePos = DucTri2.new(workspace.CurrentCamera.ViewportSize.x / 2, workspace.CurrentCamera.ViewportSize.y / 2)
													...
													if _v.Name == "Cake Prince" then
														if _v:FindFirstChild("Humanoid") and _v:FindFirstChild("HumanoidRootPart") and _v.Humanoid.Health > 0 then
															repeat task.wait()
																...
																EquipWeaponSword()
																_v.HumanoidRootPart.Size = DucTri3.new(60, 60, 60)  
																BringMobFarm = true
														...
														for i,_v2 in pairs(game:GetService("Workspace").Enemies:GetChildren()) do  
															if (_v2.Name == "Baking Staff" or _v2.Name == "Head Baker" or _v2.Name == "Cake Guard" or _v2.Name == "Cookie Crafter") and _v2.Humanoid.Health > 0 then
																repeat wait()
																	...
																	EquipWeaponSword()
																	_v2.HumanoidRootPart.Size = DucTri3.new(60, 60, 60)  
																	BringMobFarm = true
							...
							for _,l in next,Elite_All_Mon["Mon"] do
								if QuestUI.Visible == true then
										...
										for _,_1 in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
											if _1.Name == _l1 then
												if _1:FindFirstChild("Humanoid") and _1:FindFirstChild("HumanoidRootPart") and _1.Humanoid.Health > 0 then
													repeat wait()
														EquipWeapon(_G.Select_Weapon)
														_1.HumanoidRootPart.Size = DucTri3.new(60, 60, 60)  
									...
									if game.Players.LocalPlayer.Backpack:FindFirstChild(Elite_All_Mon["Item"]) or game.Players.LocalPlayer.Character:FindFirstChild(Elite_All_Mon["Item"]) then
										game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",DucTri3.new(-12471.169921875, 374.94024658203, -7551.677734375))
				...
				pcall(function()
					for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
						if _G.BringNormal and _G.Auto_Cake_Prince and StartCakeMagnet and (v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker") and (v.HumanoidRootPart.Position - POSCAKE.Position).magnitude <= 350 then
							...
							v.HumanoidRootPart.CanCollide = false
							v.HumanoidRootPart.Size = DucTri3.new(50,50,50)
							if v.Humanoid:FindFirstChild("Animator") then
								v.Humanoid.Animator:Destroy()
							end
							sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius",  math.huge)
							...
							if (SelectModeMaterial ~= "") then
								...
								if CustomFindFirstChild(MaterialMob) then
															...
															if (v5.Name == v1.Name) then
																spawn(function()
																	if InMyNetWork(v5.HumanoidRootPart) then
																		...
																		v5.HumanoidRootPart.Size = DucTri3.new(60, 60, 60);
																	end
																end);
															end
														end
									...
									if (World1 and (table.find(MaterialMob, "Fishman Commando")) and ((CFrameMon.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 50000)) then
										if Modstween then Modstween:Stop(); end wait(0.5); game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", DucTri3.new(61163.8515625, 11.6796875, 1819.7841796875));
									elseif (World1 and not (table.find(MaterialMob, "Fishman Commando")) and ((CFrameMon.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 50000)) then
										if Modstween then Modstween:Stop(); end wait(0.5); game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", DucTri3.new(3864.8515625, 6.6796875, -1926.7841796875));
									elseif (World1 and (table.find(MaterialMob, "God's Guard")) and ((CFrameMon.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 3000)) then
										if Modstween then Modstween:Stop(); end wait(0.5); game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",DucTri3.new(-4607.8227539063, 872.54248046875, -1667.5568847656));
								...
								for _, _v1 in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
									if string.find(_v1.Name, _Boss) then
										if _v1:FindFirstChild("Humanoid") and _v1:FindFirstChild("HumanoidRootPart") and _v1.Humanoid.Health > 0 then
											repeat wait()
												EquipWeapon(_G.Select_Weapon)
												_v1.HumanoidRootPart.Size = DucTri3.new(60, 60, 60)  
												BringMobFarm = true
			...
			if not isnil(v.Character) then
				if ESPPlayer then
					if not isnil(v.Character.Head) and not v.Character.Head:FindFirstChild('NameEsp' .. Number) then
						...
						bill.ExtentsOffset = DucTri3.new(0, 1, 0)
								...
								for _,_v3 in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
									if _v3.Name == Rip_Indar_All_Mon["Boss"] then
										if _v3:FindFirstChild("Humanoid") and _v3:FindFirstChild("HumanoidRootPart") and _v3.Humanoid.Health > 0 then
											repeat wait()
												EquipWeapon(_G.Select_Weapon)
												_v3.HumanoidRootPart.Size = DucTri3.new(60, 60, 60)  
												...
												if v.Name == "Mob Leader" then
													if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
														repeat task.wait()
															...
															v.Humanoid.WalkSpeed = 0
															v.Head.CanCollide = false
															v.HumanoidRootPart.Size = DucTri3.new(100,100,100)
															v.HumanoidRootPart.Transparency = 1
															EquipWeapon(_G.Select_Weapon)
															getgenv().ToTarget(v.HumanoidRootPart.CFrame * MethodFarm)
															if not _G.FastAttack or not _G.FastAttackO or _G.FastAttack or _G.FastAttackO or _G.SuperFastAttack then game:GetService'VirtualUser':CaptureController() game:GetService'VirtualUser':Button1Down(DucTri2.new(1280, 672)) end
				...
				if _G.Auto_Farm_Ectoplasm then
					pcall(function()
						if game:GetService("Workspace").Enemies:FindFirstChild("Ship Deckhand") or game:GetService("Workspace").Enemies:FindFirstChild("Ship Engineer") or game:GetService("Workspace").Enemies:FindFirstChild("Ship Steward") or game:GetService("Workspace").Enemies:FindFirstChild("Ship Officer") then
							...
							MagnetEctoplasm = false
							local Distance = (DucTri3.new(904.4072265625, 181.05767822266, 33341.38671875) - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
							if Distance > 20000 then
								game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",DucTri3.new(923.21252441406, 126.9760055542, 32852.83203125))
							end
							getgenv().ToTarget(CFrame.new(904.4072265625, 181.05767822266, 33341.38671875))
						end
					end)
					...
					if _G.Auto_Evo_Race_V2 then
						if not game:GetService("Players").LocalPlayer.Data.Race:FindFirstChild("Evolved") then
							if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist","1") == 0 then
								...
								if (DucTri3.new(-2779.83521, 72.9661407, -3574.02002) - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 4 then
									wait(1.3)
					...
					if _G.Auto_Musketeer_Hat then
						if game:GetService("Players").LocalPlayer.Data.Level.Value >= 1800 and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CitizenQuestProgress").KilledBandits == false then
							if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Forest Pirate") and string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "50") and game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
								...
								if (DucTri3.new(-12443.8671875, 332.40396118164, -7675.4892578125) - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 30 then
									wait(1.5)
		...
		spawn(function()
			while wait() do
				if _G.Auto_Holy_Torch then
					pcall(function()
						wait(1)
						repeat getgenv().ToTarget(CFrame.new(-10752, 417, -9366)) wait() until not _G.Auto_Holy_Torch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-DucTri3.new(-10752, 417, -9366)).Magnitude <= 10
						wait(1)
						repeat getgenv().ToTarget(CFrame.new(-11672, 334, -9474)) wait() until not _G.Auto_Holy_Torch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-DucTri3.new(-11672, 334, -9474)).Magnitude <= 10
						wait(1)
						repeat getgenv().ToTarget(CFrame.new(-12132, 521, -10655)) wait() until not _G.Auto_Holy_Torch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-DucTri3.new(-12132, 521, -10655)).Magnitude <= 10
						wait(1)
						repeat getgenv().ToTarget(CFrame.new(-13336, 486, -6985)) wait() until not _G.Auto_Holy_Torch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-DucTri3.new(-13336, 486, -6985)).Magnitude <= 10
						wait(1)
						repeat getgenv().ToTarget(CFrame.new(-13489, 332, -7925)) wait() until not _G.Auto_Holy_Torch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-DucTri3.new(-13489, 332, -7925)).Magnitude <= 10
					end)
				end
			end
		end)
					...
					if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
						pcall(function()
							repeat wait(.1)
								...
								v.Humanoid.Health = 0
								v.HumanoidRootPart.CanCollide = false
								v.HumanoidRootPart.Size = DucTri3.new(500,500,500)
								v.HumanoidRootPart.Transparency = 1
							until not _G.Auto_Dungeon_Superhuman or not v.Parent or v.Humanoid.Health <= 0
						end)
					end
			...
			if _G.Start_Tween_Island == true or _G.Settings.Start_Tween_Island then
				repeat wait()
					...
					elseif _G.Select_Island == "Sky Island 3" then
						game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",DucTri3.new(-7894.6176757813, 5547.1416015625, -380.29119873047))
				...
				if (game:GetService("Workspace").Map["Temple of Time"].DoNotEnter.CFrame.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 2000 then
					...
					elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Fishman" then
							for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
								if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 1000 then
									repeat wait()
										v.HumanoidRootPart.Size = DucTri3.new(150,150,150)
										v.HumanoidRootPart.CanCollide = false
										v.Humanoid.WalkSpeed = 0
										v.Head.CanCollide = false
										v.HumanoidRootPart.Transparency = 1
			...
			if _G.AutoMirageIsland or _G.Mirage then
				if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
					...
					if _G.Mode == "English" then
						game:GetService("StarterGui"):SetCore("SendNotification",{Title = "DucTriHub",Text = "Mirage not Found!",Icon = "rbxassetid://14645512457",Duration = 1})
					else
						game:GetService("StarterGui"):SetCore("SendNotification",{Title = "DucTriHub",Text = "เกาะลับยังไม่เกิด",Icon = "rbxassetid://14645512457",Duration = 1})
					end
				end
			end
		end
	...
	local function round(n)
		...
		function LockMoon()
			...
			if _G.LockMoon then
				...
				local pos = DucTri3.new(0, 0, 0)
				local lookAt = Lighting:GetMoonDirection()
				local cameraCFrame = CFrame.new(pos, lookAt)
				workspace.CurrentCamera.CFrame = cameraCFrame
				local CameraDirection = Root.CFrame:toObjectSpace(cameraCFrame).lookDucTri.unit
    ...
    Callback = function(value)
        ...
        while _G.Bboat do wait()
            toTarget(CFrame.new(-16931.9766, 9.08636189, 444.637634, 0.247219667, 3.04388195e-08, 0.968959451, -2.25711698e-08, 1, -2.56551314e-08, -0.968959451, -1.55280944e-08, 0.247219667))
                if (DucTri3.new(-16931.9766, 9.08636189, 444.637634, 0.247219667, 3.04388195e-08, 0.968959451, -2.25711698e-08, 1, -2.56551314e-08, -0.968959451, -1.55280944e-08, 0.247219667) - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 5 and CheckNotifyBuy() == false then
                    repeat wait()
                    if SelectBoat then 
                        local args = {
                            [1] = "BuyBoat",
                                ...
                                Callback = function(value)
                                    ...
                                    spawn(function()
                                        while wait() do
                                            ...
                                            repeat wait() toTarget(CFrame.new(-16529.4922, 75.8897476, 310.603882, -0.292773664, -7.61506485e-08, -0.956181765, -4.15630765e-08, 1, -6.69141258e-08, 0.956181765, 2.01511625e-08, -0.292773664)) until (DucTri3.new(-16529.4922, 75.8897476, 310.603882, -0.292773664, -7.61506485e-08, -0.956181765, -4.15630765e-08, 1, -6.69141258e-08, 0.956181765, 2.01511625e-08, -0.292773664) - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 1 or not _G.QRepairBoat
                                            local args = {
                                                [1] = "Shipwright"
                                            }
		...
		MiscSection:AddToggle{
			...
			game:GetService("RunService").RenderStepped:Connect(function()
				if _G.click then
					 pcall(function()
						game:GetService'VirtualUser':CaptureController()
						game:GetService'VirtualUser':Button1Down(DucTri2.new(0,1,0,1))
					end)
				end
			end)
		end)
		...
		while task.wait() do
			pcall(function()
				if _G.WalkWater then
					game:GetService("Workspace").Map["WaterBase-Plane"].Size = DucTri3.new(1000,112,1000)
				else
					game:GetService("Workspace").Map["WaterBase-Plane"].Size = DucTri3.new(1000,80,1000)
				end
			end)
		end
	end)
...
function kaituncap()
	...
	local ListHuhu = {
		["Superhuman"] = DucTri2.new(3, 2),
		["DeathStep"] = DucTri2.new(4, 3),
		["ElectricClaw"] = DucTri2.new(2, 0),
		["SharkmanKarate"] = DucTri2.new(0, 0),
		["DragonTalon"] = DucTri2.new(1, 5)
	}
	...
	for k, v in pairs(cac) do
		if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
			...
			huhu.ImageRectSize = DucTri2.new(100, 100)
	...
	game:GetService("Players").LocalPlayer.PlayerGui.Main.Beli.AnchorPoint = DucTri2.new(0.5, 0.5)
	game:GetService("Players").LocalPlayer.PlayerGui.Main.Beli.Position = UDim2.new(0, 1120, 0, 700)
	
	game:GetService("Players").LocalPlayer.PlayerGui.Main.Level.AnchorPoint = DucTri2.new(0.5, 0.5)
...
FakeDamage("DucTri Hub")
Vec("<Color=Yellow>DucTri Hub loaded Finished<Color=/>")
